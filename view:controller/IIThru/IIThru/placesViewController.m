...
//        }
        ...
        [localSearch startWithCompletionHandler:^(MKLocalSearchResponse *response, NSError *error) {
            ...
            [response.mapItems enumerateObjectsUsingBlock:^(MKMapItem *item, NSUInteger idx, BOOL *stop) {
                ...
                annotation.title1 = @"Kentucky Fried Chicken";
                annotation.phone = item.phoneNumber;
                annotation.subtitle1 = item.placemark.addressDictionary[(NSString *)kABPersonAddressStreetKey];
...
- (void)mapView:(MKMapView *)mapView annotationView:(MKAnnotationView *)view calloutAccessoryControlTapped:(UIControl *)control
{
    ...
    ABRecordSetValue(person, kABPersonOrganizationProperty, (__bridge CFStringRef) annotation.title1, NULL);
